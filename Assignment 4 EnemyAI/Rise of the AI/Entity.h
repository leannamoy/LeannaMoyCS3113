...
enum AIType { WALKER, GUARD, SKATER, SHOOTER, JUMPER};
enum AIState { IDLE, ATTACKING, WALKING, SKATING, SHOOTING, JUMPING };
...
private:
    ...
    Entity* shooter_owner; ////a pointer to the projectile's owner, if applicable
...
public:
    ...
    void const set_shield(bool val) { shielding = val; };

    void        set_owner(Entity* owner) { shooter_owner = owner; };
};