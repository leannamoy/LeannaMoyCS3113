...
void Utility::draw_object(glm::mat4& object_model_matrix, GLuint& object_texture_id, ShaderProgram* program, glm::vec3 position)
{
    // Vertices
    float vertices[] = {
    ...
    object_model_matrix = glm::translate(object_model_matrix, position);
